...
import { ModalExclusaoConfig } from './modal-exclusao.config';
...
export class ModalExclusaoComponent implements OnInit {
  @Input() public modalConfig: ModalExclusaoConfig;
  @Output() funcaoRecebida: EventEmitter<any> = new EventEmitter();
  @ViewChild('modalPadrao')
  private modalPadrao: TemplateRef<ModalExclusaoComponent>;
  ...
  async open(): Promise<boolean> {
    return new Promise<boolean>((resolve) => {
      this.modalRef = this.modal.open(this.modalPadrao, this.ngbModalOptionsSm);
